...
|JSON Merge Patch
|JSON Merge Patch payload of changes to an updated (partial) collection description
...
|`application/merge-patch+json`
|JSON Merge Patch
|JSON Merge Patch payload of changes to an updated (partial) collection item
