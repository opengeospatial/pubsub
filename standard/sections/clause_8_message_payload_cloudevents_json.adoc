...
OGC API ``type`` patterns are defined to communicate to a client the type of event the message represents.  It is expected that downstream OGC API "resource" based standards will inherit and concretely define channels related to core workflows and events of those respective standards.
...
include::../recommendations/message-payload-cloudevents-json/REC_type.adoc[]
