...
By inspecting the message payload definition in the AsyncAPI channel, a client can perform the below workflows against messages when subscribed to the relevant channel:
